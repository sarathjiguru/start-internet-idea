angular.module('sociogram.controllers', [])
    ...
    .controller('AppCtrl', function ($scope, $state, OpenFB) {
        ...
        $scope.revokePermissions = function () {
            OpenFB.revokePermissions().then(
                function () {
                    $state.go('app.login');
                    // clear cookies; if asked to revokePermissions
    ...
    .controller('LoginCtrl', function ($scope, $location, OpenFB) {
        ...
        $scope.facebookLogin = function () {
            ...
            OpenFB.login('email,read_stream,user_friends').then(
                function () {
    ...
    .controller('FriendsCtrl', function ($scope, $stateParams, OpenFB) {
      console.log('FriendsCtrl'+$stateParams.personId);
    ...
    .controller('AppStoreCtrl', function ($scope, $stateParams, OpenFB) {
        cordova.plugins.market.open("in.agora", {
          success: function() {
